...
public class CounterStatus {
    ...
    private CounterMediaAttachment[] media_attachments;
    private CounterApplication application;
    private CounterMention[] mentions;
    private CounterStatusTag[] tags;
    private CounterCustomEmoji[] emojis;
    ...
    private CounterFilterResult[] filtered;
}